  ...
  return (
    <footer className="w-full h-[400px]  text-white flex items-center justify-center">
          <div className="footer w-[600px] h-[200px] m-auto flex flex-col items-center gap-8 text-center">
            <h2 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "2.5rem", fontWeight: 900, lineHeight: 1.2, margin: 0 }} className="pt-10 text-white">
           ...
           <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="btn-footer text-white">Contact us! </button>
        </div>
          </div>
